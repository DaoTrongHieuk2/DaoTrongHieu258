...
namespace DaoTrongHieu258.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public SinhVienController(DTH258 context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaSinhVien,NgaySinh,SoDienThoai")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSinhVien,NgaySinh,SoDienThoai")] SinhVien sinhVien)
        {
